 ...
 */
    std::string getURDFpath() {
      ...
      urdfPath += "/benchmark/ANYmal-PD-benchmark/ode-rai-dart/robot.urdf";
 ...
 */
    std::string getBulletPlanePath() {
      ...
      std::string urdfPath(RESOURCEPATH);
      urdfPath += "/benchmark/ANYmal-PD-benchmark/bullet/plane.urdf";
 ...
 */
    std::string getBulletANYmalPath() {
      ...
      std::string urdfPath(RESOURCEPATH);
      urdfPath += "/benchmark/ANYmal-PD-benchmark/bullet/robot.urdf";
 ...
 */
    std::string getMujocoURDFpath(int rowNum) {
      ...
      std::string urdfPath(RESOURCEPATH);
      urdfPath += "/benchmark/ANYmal-PD-benchmark/mujoco/robot" + std::to_string(rowNum * rowNum) + ".urdf";
